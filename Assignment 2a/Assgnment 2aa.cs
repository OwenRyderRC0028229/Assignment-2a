...
namespace Assignment_2a
{
    public partial class Form1 : Form
    {
        ...
        {// Three Resistors in a Parallel Circuit
            try
            {
        ...
        {// Four Resistors in a Parallel Circuit
            try
            {
        ...
        {// Five Resistors in a Parallel Circuit
            try
            {
        ...
        {// Four Resistors in a Series Circuit
            try
            {
        ...
        {// Five Resistors in a Series Circuit
            try
            {
        ...
        private void Res1S_TextChanged(object sender, EventArgs e)
        {
